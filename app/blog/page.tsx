              ...
              <div className="order-1 lg:order-1 lg:col-span-1 space-y-3 sm:space-y-4 lg:space-y-5 lg:sticky lg:top-24 lg:self-start">
                ...
                {allTags.length > 0 && (
                  <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    >
                      <h3 className="text-lg sm:text-xl font-bold text-gray-900">Popular tags</h3>
                      <span className="lg:hidden text-xs font-semibold text-red-600">
                        {showMobileTags ? 'Hide' : 'Show'}
                      </span>
                    </button>
                ...
                {latestPosts.length > 0 && (
                  <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    >
                      <h3 className="text-lg sm:text-xl font-bold text-gray-900">Latest Post</h3>
                      <span className="lg:hidden text-xs font-semibold text-red-600">
                        {showMobileLatest ? 'Hide' : 'Show'}
                      </span>
                    </button>
