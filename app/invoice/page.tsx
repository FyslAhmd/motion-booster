...
export default function InvoicePage() {
  return (
    <div data-invoice-root="true" className="min-h-screen bg-[#d9d9d9] px-3 py-4 font-sans print:min-h-0 print:bg-white print:px-0 print:py-0">
      <div className="invoice-sheet mx-auto w-full max-w-[780px] bg-[#ececec] p-3 print:max-w-none print:p-0">
        <div className="flex items-start justify-between bg-black px-4 py-3.5 sm:px-5 sm:py-4">
          <div className="pr-3">
            <Image
              ...
              width={230}
              height={62}
              className="h-auto w-37.5 object-contain sm:w-[210px]"
              priority
            />
        ...
        <div className="px-1 pt-3 sm:px-2 sm:pt-4">
          <div className="flex items-start justify-between gap-2.5">
            ...
            <div className="flex min-w-[170px] flex-col gap-1.5 sm:min-w-[182px]">
          ...
          <div className="mt-3 rounded-[4px] bg-[#ef0914] py-1 text-center text-[18px] font-black tracking-[1px] text-white sm:text-[30px] sm:leading-[1.1]">
            BILL RECEIPT
          </div>
          ...
          <div className="mt-2">
            <table className="w-full border-separate border-spacing-[2px]">
              <thead>
                <tr>
                  <th className="w-[50%] rounded-[4px] bg-black px-2 py-1.5 text-center text-[10px] font-normal text-white sm:text-[16px]">Name of Service</th>
                  <th className="w-[17%] rounded-[4px] bg-black px-2 py-1.5 text-center text-[10px] font-normal text-white sm:text-[16px]">
                    Amount
                  ...
                  <th className="w-[16%] rounded-[4px] bg-black px-2 py-1.5 text-center text-[10px] font-normal text-white sm:text-[16px]">Sub Total</th>
                </tr>
              </thead>
              <tbody>
                {invoiceData.services.map((service) => (
                  <tr key={service.id}>
                    <td className="h-16 rounded-[4px] bg-[#d8d8d8] px-2 py-2 align-top text-[11px] font-normal text-black sm:h-20 sm:px-3 sm:py-2.5 sm:text-[18px]">
                      {service.id}. {service.name}
                    </td>
                    <td className="h-16 rounded-[4px] bg-[#d8d8d8] px-1 py-2 text-center text-[11px] font-normal text-black sm:h-20 sm:text-[18px]">{service.amount}</td>
                    <td className="h-16 rounded-[4px] bg-[#d8d8d8] px-1 py-2 text-center text-[11px] font-normal text-black sm:h-20 sm:text-[18px]">{service.perDollar}</td>
                    <td className="h-16 rounded-[4px] bg-[#d8d8d8] px-1 py-2 text-center text-[11px] font-normal text-black sm:h-20 sm:text-[18px]">{service.subTotal}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-2 rounded-[4px] bg-[#ef1f22] px-2 py-1 text-right text-[14px] font-normal text-white sm:text-[20px] sm:leading-[1.1]">
            Sub Total amount= {invoiceData.subTotalAmount}
          </div>

          <div className="mt-2 overflow-hidden rounded-[6px] border border-[#cfcfcf] bg-[#d8d8d8]">
          ...
          <div className="mt-2 flex items-end justify-between gap-2.5">
            ...
            <div className="rounded-[4px] bg-[#ef1f22] px-2 py-1 text-[14px] font-normal text-white sm:text-[20px] sm:leading-[1.1]">
