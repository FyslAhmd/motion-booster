          ...
          <div className="grid grid-cols-1 gap-3 sm:gap-4 md:gap-6" suppressHydrationWarning>
            {faqs.map((faq, index) => {
              ...
              return (
                <div
                  key={faq.id}
                  className={`faq-item bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-7 shadow-sm hover:shadow-md transition-shadow border border-gray-100 ${index % 2 === 0 ? 'card-reveal-left' : 'card-reveal-right'}`}
