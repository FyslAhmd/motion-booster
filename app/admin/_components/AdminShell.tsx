...
const navItems = [
  ...
  { href: '/admin/popular-services', label: 'Popular Services', icon: Briefcase },
  { href: '/admin/team', label: 'Team', icon: Users },
  { href: '/admin/faq', label: 'FAQ', icon: MessageSquare },
  { href: '/admin/testimonials', label: 'Testimonials', icon: Star },
  { href: '/admin/stats', label: 'Stats & Achievements', icon: BarChart2 },
  { href: '/admin/portfolio', label: 'Portfolio', icon: Briefcase },
  { href: '/admin/chat', label: 'Chat Messages', icon: MessageCircle },
  { href: '/admin/meta', label: 'Meta Connect', icon: Share2 },
      ...
      >
        ...
        <div className="p-3 border-t border-gray-100 space-y-0.5">
          ...
          <Link
            ...
            onClick={() => setSidebarOpen(false)}
            className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${
              pathname === '/admin/profile' ? 'bg-red-600 text-white shadow-md shadow-red-500/20' : 'text-gray-500 hover:text-gray-900 hover:bg-red-50'
            }`}
          >
            {adminAvatar ? (
